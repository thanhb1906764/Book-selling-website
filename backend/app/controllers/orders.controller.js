...
exports.deleteAll = async (req, res, next) => {
    try {
        ...
        if (req.body) {
            const deletedCount = await ordersService.deleteAll(req.body);
            return res.send({
...
exports.dropCollection = async (req, res, next) => {
    try {
        const ordersService = new OrdersService(MongoDB.client, req.params.name);
        const kq = await ordersService.drop()
        return res.send(kq)
