    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary ">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <form class="d-flex w-50" @submit.prevent="Submit">
                    <div class="input-group">
                        <!-- <input type="text" class="form-control" placeholder="Nhập tên sản phẩm"
                            aria-label="Nhập tên sản phẩm" aria-describedby="button-addon2"> -->
                        <input type="text" class="form-control" v-model="value" placeholder="Nhập tên sách tìm kiếm..."
                            list="browsers" name="browser" id="browser">
                        <button class="btn btn-outline-secondary" type="submit" @click="search"><i
                                class="fas fa-solid fa-magnifying-glass"></i></button>
...
export default {
    ...
    methods: {
        ...
        getNameBook() {
            this.bookList = useDataStore().getBooks.filter(book => book.author !== undefined).map(object => object.bookName)
        }
    },
    computed: {
        getNameUser() {
