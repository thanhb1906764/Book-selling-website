<template>
    <h3 class="text-center font-weight-bold" style="padding: 20px;color: #356859;">QUẢN LÝ SẢN PHẨM</h3>
                    ...
                    <v-card-text>
                        ...
                        <v-row>
                            <v-col v-for="item in geneList" :key="item._id">
                                <strong type="button" class="gene" @click="pillGenes(1, item.genreName)">{{ item.genreName
                                }}</strong>
